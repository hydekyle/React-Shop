...
const description = "Crea tu propio monstruo personalizado y lucha por turnos"

const screenshots = [
    {
        src: 'https://i.ibb.co/xFzrytD/3.png',
        altText: '',
        caption: ''
    },
    {
        src: 'https://i.ibb.co/VCJnSPJ/4.png',
        altText: '',
        caption: ''
    },
    {
        src: 'https://i.ibb.co/hL9873Y/5.png',
        altText: '',
        caption: ''
    },
    {
        src: 'https://i.ibb.co/M6yqp11/6.png',
        altText: '',
        caption: ''
    }
