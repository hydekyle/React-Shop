...
const title = "Cricket Arcade"
const description = "Batea la bola con presición para romper las dianas"

const items = [
    {
        src: 'https://i.ibb.co/t2j6rwj/2.png',
        altText: '',
        caption: ''
    },
    {
        src: 'https://i.ibb.co/7YTX5jN/unnamed.png',
        altText: '',
        caption: ''
    },
    {
        src: 'https://i.ibb.co/b7m88XB/unnamed.png',
        altText: '',
        caption: ''
    }
